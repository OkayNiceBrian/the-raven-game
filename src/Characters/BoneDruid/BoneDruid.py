...
class BoneDruid(Character):
    ...
    def __init__(self, 
                ...
                description = "Long ago, the Bone Druid was a simple village mage, treating the sick and expecting nothing but peace in return. When the imperial nations started warring over resources and supremacy, the village was burned to the ground. Only ash and bone remained. Driven half mad, the Bone Druid has since dedicated their life to destroying the imperial order. No art is too dark to serve this cause...",
                base_health = 900,
                base_physical = 10,
                base_magic = 90,
                base_phys_resist = 10,
